...
const { StaleWhileRevalidate, NetworkFirst, NetworkOnly } = require('workbox-strategies');
...
const bgSyncPlugin = new BackgroundSyncPlugin('react-pwa-sync', {});
registerRoute(
  ({ url }) => url.origin === 'http://localhost:8000',
  new NetworkOnly({
